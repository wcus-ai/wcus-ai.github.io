...
The Abilities API is a developer feature gives WordPress a single, discoverable registry of what a site can do. Like hooks but for consumable APIs, Abilities are a functional primitive that allow 3rd party code to integrate with plugin and custom functionality as if it were a first-party feature.
