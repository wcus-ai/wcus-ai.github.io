...
import { generateComment, generateHtml, normalizeHeights, routesFor } from './lib/report.mjs';
...
for (const route of routes) {
  ...
  try {
    ...
    let before = PNG.sync.read(beforeBuf);
    let after = PNG.sync.read(afterBuf);
